...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var HE = endpoints.addEndpoint("1", "Horas Extras", endpointType.genericSensor);
  HE.variableTypeId=1203;
  var Grad = endpoints.addEndpoint("2", "Graduación", endpointType.genericSensor);
  Grad.variableTypeId=1198;
}
